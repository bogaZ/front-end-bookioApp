...
class InformasiPribadi extends StatefulWidget {
  static const routeName = "/informasiPribadi";
  InformasiPribadi({Key? key}) : super(key: key);

  @override
  _InformasiPribadiState createState() => _InformasiPribadiState();
}
  ...
  PesanKonfirmasi(BuildContext context, var data, UserProvider userProvider) {
    Widget okButton = Container(
      ...
      child: ElevatedButton(
          ...
          onPressed: () {
            userProvider.updateUser(data, "penyewa", context);
          },
          child: Text('Simpan')),
    );
