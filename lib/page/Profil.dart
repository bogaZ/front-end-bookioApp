...
import 'InformasiPribadi.dart';
import 'package:flutter/material.dart';

import 'UbahPassword.dart';

class Profil extends StatefulWidget {
  static const routeName = "/profilPenyewa";
...
class _ProfilState extends State<Profil> {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.pushNamed(
                                  context, InformasiPribadi.routeName,
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.pushNamed(
                                  context, UbahPassword.routeName);
                            },
                            child: Container(
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(10),
  ...
  void logout() async {
    ...
    if (body['success']) {
      ...
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => LoginPenyewa()));
    }
  }
}
