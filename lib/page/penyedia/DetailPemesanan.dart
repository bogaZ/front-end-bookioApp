...
class DetailPemesananPenyedia extends StatelessWidget {
  static const routeName = "/DetailPemesananPenyedia";
  const DetailPemesananPenyedia({Key? key}) : super(key: key);
      ...
      child: Scaffold(
          ...
          body: Consumer<PemesananProvider>(
            ...
            return FutureBuilder(
                future: pemesananProvider.getDetailPemesananLangsung(id),
