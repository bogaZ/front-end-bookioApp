    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          DetailStudio.nameRoute: (context) => DetailStudio(),
          ...
          NotifikasiPenyedia.routeName: (context) => NotifikasiPenyedia(),
          CekTransaksi.routeNmae: (context) => CekTransaksi(),
